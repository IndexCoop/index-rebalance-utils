...
config_1.subtask(task_names_1.TASK_COMPILE_SOLIDITY_GET_ARTIFACT_FROM_COMPILATION_OUTPUT)
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!process.env.SKIP_ABI_GAS_MODS) {
                        artifact.abi = tasks_1.addGasToAbiMethods(network.config, artifact.abi);
                    }
...
config_1.internalTask(task_names_1.TASK_COMPILE_SOLIDITY_COMPILE).setAction(tasks_1.setupNativeSolc);
