...
export interface IndexInfo {
    ...
    path: string;
    calculateAssetAllocation(setToken: SetToken, strategyConstants: StrategyObject, setTokenValue: BigNumber): Promise<RebalanceSummary[]>;
}
...
export declare let exchanges: Exchanges;
