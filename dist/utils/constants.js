...
exports.MAX_UINT_96 = ethers_1.BigNumber.from(2).pow(96).sub(1);
exports.ONE = One;
exports.TWO = Two;
...
exports.ONE_DAY_IN_SECONDS = ethers_1.BigNumber.from(60 * 60 * 24);
exports.ONE_HOUR_IN_SECONDS = ethers_1.BigNumber.from(60 * 60);
exports.ONE_YEAR_IN_SECONDS = ethers_1.BigNumber.from(31557600);
